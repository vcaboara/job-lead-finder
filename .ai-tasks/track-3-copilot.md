...
# Task: Learning from Job Suggestions (Priority: P1)

## Assigned Agent: COPILOT

## Objectives:
   1. Track which suggested jobs user applies to / is interested in
   2. Build preference model from user feedback
   3. Improve job matching algorithm based on historical data
   4. Store acceptance/rejection patterns
...
- Title: "Learning from Job Suggestions"
- Branch: auto/track-3-learning-from-job-suggestions
